		...
		ai.evaluate = function(board, last_player_id){
			...
			score_table = {
				...
				zu: [
					...
					[140 ,0   ,180 ,0   ,130 ,0   ,180 ,0   ,140 ],

					[170 ,180 ,190 ,200 ,180 ,200 ,190 ,180 ,170 ],
				...
				ju: [
					...
					[1200,1220,1200,1250,1200,1250,1200,1220,1200],
					...
					[1230,1240,1230,1240,1240,1240,1230,1240,1230],
				...
				pao: [
					...
					[510 ,510 ,510 ,530 ,550 ,530 ,510 ,510 ,510 ],
			...
			//				console.log("tr: " + tr + " c: " + c + " score: " + score + " " + score_table[chess.type][tr][c]);
							...
							score -= score_table[chess.type][tr][c]-80; // 对方的子分值略低，防止AI不断对子
					}
				}
			}
